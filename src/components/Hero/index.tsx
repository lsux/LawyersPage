          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              ...
              <div className="mx-auto  max-w-[800px] text-center">
                ...
                <p className="sm:text-md md:text-l mb-5 text-base !leading-relaxed text-body-color dark:text-body-color-dark">
                  {BUSINESS_DESCRIPTION_1}
                </p>
                <p className="sm:text-md md:text-l mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark">
                  {BUSINESS_DESCRIPTION_2}
                </p>
